...
# Your API Access Key (Ensure it’s correct and has permissions)
...
def upload_file():
    ...
    if file:
        ...
        """
        #return jsonify({"file_url": download_url})
        #return jsonify({"file_url": f"<a href='{download_url}' target='_blank'>Click here to download</a>"})
